...
using DemoLogicApp.Tests.Mocks.ReceiveOrderWorkflow;
...
namespace DemoLogicApp.Tests
{
    ...
    public class Test2
    {
        ...
        public void Setup()
        {
            this.TestExecutor = new TestExecutor("ReceiveOrderWorkflow/testSettings.config");
        }

        /// <summary>
        /// A sample unit test for executing the workflow named ReceiveOrderWorkflow with static mocked data.
        /// This method shows how to set up mock data, execute the workflow, and assert the outcome.
        /// </summary>
        [TestMethod]
        public async Task ReceiveOrderWorkflow_Test2_ExecuteWorkflow_SUCCESS_Sample1()
        {
            // PREPARE Mock
            // Generate mock trigger data.
            var triggerMockOutput = new WhenMessagesAreAvailableInTopicTriggerOutput();
            // Sample of how to set the properties of the triggerMockOutput
            // triggerMockOutput.Body.Id = "SampleId";
            var triggerMock = new WhenMessagesAreAvailableInTopicTriggerMock(outputs: triggerMockOutput);

            // Generate mock action data.
            var actionMockOutput = new SendToOrdersinternalActionOutput();
            ...
            var actionMock = new SendToOrdersinternalActionMock(name: "Send_to_orders-internal", outputs: actionMockOutput);
        ...
        /// <summary>
        /// A sample unit test for executing the workflow named ReceiveOrderWorkflow with dynamic mocked data.
        /// This method shows how to set up mock data, execute the workflow, and assert the outcome.
        /// </summary>
        [TestMethod]
        public async Task ReceiveOrderWorkflow_Test2_ExecuteWorkflow_SUCCESS_Sample2()
        {
            // PREPARE
            // Generate mock trigger data.
            var triggerMockOutput = new WhenMessagesAreAvailableInTopicTriggerOutput();
            ...
            var actionMock = new SendToOrdersinternalActionMock(name: "Send_to_orders-internal", onGetActionMock: SendToOrdersinternalActionMockOutputCallback);
            // OPTION 2: defining inline using a lambda
            /*var actionMock = new SendToOrdersinternalActionMock(name: "Send_to_orders-internal", onGetActionMock: (testExecutionContext) =>
            {
                return new SendToOrdersinternalActionMock(
                    status: TestWorkflowStatus.Succeeded,
                    outputs: new SendToOrdersinternalActionOutput {
        ...
        public SendToOrdersinternalActionMock SendToOrdersinternalActionMockOutputCallback(TestExecutionContext context)
        {
